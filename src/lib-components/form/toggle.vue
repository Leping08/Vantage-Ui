<template>
  ...
  <button 
    ...
    :class="[
      ...
      `relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-${toggleColor}-500`
    ]">
    ...
    <span 
      ...
      <span 
        ...
        aria-hidden="true">
        <svg :class="`h-3 w-3 text-${toggleColor}-600`" fill="currentColor" viewBox="0 0 12 12">
